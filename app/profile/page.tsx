            ...
            <div className="bg-white rounded-2xl shadow-sm border border-neutral-100 p-6 lg:p-8">
                ...
                {saveError && (
                    <div className="flex items-center gap-2 text-sm text-red-700 bg-red-50 border border-red-200 rounded-xl px-4 py-2.5 mb-4">
                        ...
                        <span>Save failed: <span className="font-semibold">{saveError}</span></span>
                    </div>
                )}
                {saveSuccess && (
                ...
                <div className="flex flex-wrap items-center justify-between mt-8 pt-6 border-t border-neutral-100 gap-3">
                    ...
                    <div className="flex gap-3">
                        <button
                            onClick={handleSave}
                            disabled={isSaving}
                            className="flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-semibold border border-neutral-200 text-neutral-600 hover:bg-neutral-50 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                        >
                            {isSaving ? (
                        ...
                        {currentStep === steps.length - 1 ? (
                            <button
                                ...
                                disabled={isSaving}
                                className="flex items-center gap-2 px-6 py-2.5 rounded-xl text-sm font-semibold bg-emerald-600 text-white hover:bg-emerald-700 shadow-md shadow-emerald-600/20 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                {isSaving ? (
